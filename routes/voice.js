...
<Response>
  ...
  <Hangup/>
    ...
    console.log(`📵 Missed call forwarded from business line: ${From}`);
    ...
    // Hang up silently — the business line's voicemail handles the caller,
    // the SMS text-back is already scheduled above
    res.type('text/xml');
